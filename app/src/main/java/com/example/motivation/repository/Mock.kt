...
import com.example.motivation.infra.MotivationConstants.FILTERS.HAPPY
import com.example.motivation.infra.MotivationConstants.FILTERS.MORNING
import java.util.*
...
class Mock {
    ...
    private val morning = MotivationConstants.FILTERS.MORNING
    ...
    fun getPhrase(categoryId: Int): String{
        val filtered = listPhrases.filter { (it.category == categoryId) || categoryId == ALL }
        val rand = Random().nextInt(filtered.size)
        return listPhrases[rand].description
